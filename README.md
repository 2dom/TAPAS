...
![PCB](images/TAPAS_both_sides3.JPG "PCB")
...
<table style="width:100%;background-color:white" cellspacing="0" cellpadding="0" border="0" >
  <tr>
    <th><img src="images/esd.png" width="150px"><br>
	 <img src="images/erad.png" width="150px"></th>
	  <th align="left"><b>
...
+ Never short-circuit the inverter output and never enable high- and low-side switches at the same time. Always ensure the minimum dead time between switching high- and low-side switches of half-bridges. Failure to do so will most likely destroy the board.
+ In case of board failure, disconnect power source immediately. Never inhale fumes comming from the board.
...
A: Simple - join the TAPAS comunity challenge <https://challenge.tapas.sdi.tools/>, pitch an idea and get a free board. There are also neat prizes to win if you like that kind of thing.
